...
def parseArguments(arguments):
  ...
  result = list(map(lambda x: "include_directories(" + x + ")", includes))
  result.extend(map(lambda x: "add_definitions(-D" + x + ")", defines))
  result.extend(map(lambda x: "set(CMAKE_C_FLAGS \"${CMAKE_C_FLAGS} " + x + "\")", options))
